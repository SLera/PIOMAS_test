...
#mask = np.load('/home/lera/NIERSC/Scripts/IceVolume/PIOMAS_test/POIMASCryosat_Greenland/GreenlandSea_mask_Vi_EASE2N.npy')[144:576, 144:576]
...
for f in range(len(flist)):
    ...
    Vip_Gr = Read_Hi_data.extract_Greenland_Vi(Vip)
    if np.nanmin(Vip)<0:
        print flist[f]
        plt.figure()
        ...
        plt.colorbar()
        plt.savefig('/home/lera/NIERSC/Scripts/IceVolume/PIOMAS_test_results/output/Greenland/EASE2N_grid_v2/'+str(datestamp[f])+'v2_.png')
        plt.close()
