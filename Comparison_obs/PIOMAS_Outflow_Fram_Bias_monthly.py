...
#
plt.figure()
plt.plot(range(len(months_winter)),bias_cr,  'o', markersize=8,  markeredgecolor = 'darkorange', markerfacecolor = 'orange', label = 'Ricker2017')
...
plt.figure()
plt.plot(range(len(months_winter)),rmse_cr,  'o', markersize=8,  markeredgecolor = 'darkorange', markerfacecolor = 'orange', label = 'Ricker2017')
...
plt.figure()
plt.plot(range(len(months_winter)),rpd_cr,  'o', markersize=8,  markeredgecolor = 'darkorange', markerfacecolor = 'orange', label = 'Ricker2017')
